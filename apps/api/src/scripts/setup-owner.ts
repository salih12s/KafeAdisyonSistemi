...
import { IdentityService, normalizeUsername } from '../modules/identity/identity-service';
import { PASSWORD_MAX_LENGTH, PASSWORD_MIN_LENGTH } from '../modules/identity/password';
