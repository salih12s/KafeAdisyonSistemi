...
import { createOrderEventHub, type OrderEventHub } from '../../src/modules/orders/order-events';
import { createRealtimeServer, type RealtimeServer } from '../../src/modules/orders/order-realtime';
...
describe('Hazırlık API ve durum akışı', () => {
...
describe('Socket.IO authentication ve event hattı', () => {
