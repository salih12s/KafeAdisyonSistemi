...
import { HealthIndicator } from '../../shared/health/health-indicator';
import { APP_NAME, APP_TAGLINE } from '../../shared/config/app-info';
import { findNavItem } from '../navigation';
import { formatClock, formatDay } from '../../shared/lib/datetime';
import { USER_ROLE_LABELS } from '@kafe/contracts';
import { useMutation, useQueryClient } from '@tanstack/react-query';
import { useNavigate } from 'react-router-dom';
import { AUTH_QUERY_KEY, useCurrentUser } from '../../features/auth/hooks/use-auth';
